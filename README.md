...
DaVinci Resolve with Fusion Lua scripting support. Resolve/Fusion 17 or newer is recommended. This beta is currently tested on the developer's Resolve setup and is released as `beta 0.0.4a`.
